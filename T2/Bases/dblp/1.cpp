...
void createfilesH()
{
    files.push_back("dblp50mbH.out");
    files.push_back("dblp100mbH.out");
    files.push_back("dblp200mbH.out");
}
void createfilesHRl()
{
...
void createfilesRl()
{
    files.push_back("dblp50mbRl.out");
    files.push_back("dblp100mbRl.out");
    files.push_back("dblp200mbRl.out");
}
