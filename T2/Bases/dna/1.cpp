...
void createfilesH()
{
    files.push_back("dna50mbH.out");
    files.push_back("dna100mbH.out");
    files.push_back("dna200mbH.out");
}
void createfilesHRl()
{
...
void createfilesRl()
{
    files.push_back("dna50mbRl.out");
    files.push_back("dna100mbRl.out");
    files.push_back("dna200mbRl.out");
}
